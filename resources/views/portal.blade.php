...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiase bg-gray-500">
        ...
        <main class="h-screen w-full flex items-center justify-center">
            @if (Route::has('login'))
            <div class="flex flex-col items-center bg-white m-w-2/6 rounded-md p-3 h-60 justify-between shadow-lg" style="min-width: 400px">
                <h2 class="text-xl mt-4 text-center">Please log in or register to use Back Office</h2>
