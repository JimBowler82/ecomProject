                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-bold leading-5 text-blue-500 bg-white border border-gray-300 cursor-default">{{ $page }}</span>
                                    </span>
                                @else
