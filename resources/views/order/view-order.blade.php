    ...
    <div class="pt-20 pb-3 pl-6 pr-6 bg-gray-500">
        ...
        <div class='p-6 mx-auto bg-white rounded shadow-xl' style="max-width: 800px">
            ...
            <div class="flex items-center justify-between mb-2">
                ...
                <form action="{{ url("orders/$order->id") }}" method="post">
                    ...
                    <button type="button" id="delete"
                        class="px-2 py-2 font-bold text-white transition-colors duration-300 bg-red-600 border-2 border-red-600 rounded-md hover:bg-red-400">
                        Delete Order
                    </button>
                </form>
            </div>
            ...
            <div class="p-2 mt-2 border border-gray-200 rounded">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        {{ $paymentObject->charges->data[0]['billing_details']['phone'] ?? 'None' }}
                    </li>
                </ul>
            </div>
            ...
            <div class="p-2 mt-2 border border-gray-200 rounded">
                ...
                <div class="mt-6">
                    ...
                    <p>
                        ...
                        £{{ number_format(($order['total'] - $order['sub_total']) / 100, '2', '.', '') }}
                    </p>
                    <p>
                        <strong>Total:</strong>
            ...
            <div class="p-2 mt-2 border border-gray-200 rounded">
                ...
                <ul>
                    <li>
                        ...
                        {{ strtoupper($paymentObject->currency) }}
                    </li>
                    <li>
                        <strong>Type: </strong>
                        {{ ucwords($paymentObject->charges->data[0]['payment_method_details']->type) }}
                    </li>
                    <li>
                        <strong>Brand: </strong>
                        {{ ucwords($paymentObject->charges->data[0]['payment_method_details']->card->brand) }}
                    </li>
                    <li>
                        <strong>Last 4: </strong>
                        {{ $paymentObject->charges->data[0]['payment_method_details']->card->last4 }}
                    </li>
                    <li>
                        <strong>Status: </strong>
                        {{ strtoupper($paymentObject->charges->data[0]->status) }}
                    </li>
                    <li>
                        <strong>Amount Received: </strong>
                        £{{ number_format($paymentObject->amount_received / 100, '2', '.', '') }}
                    </li>
                </ul>
            ...
            <div class="p-2 mt-2 border border-gray-200 rounded">
                ...
                <a href="{{ $paymentObject->charges->data[0]->receipt_url }}" target="_blank"
                    class="px-2 py-1 ml-4 text-white transition-colors duration-300 bg-gray-800 rounded hover:bg-green-300 hover:text-gray-800">
                    View Receipt
                </a>
